                                        ...
                                        <div className="img-detail">
                                                ...
                                                <div className="index-delivery">
                                                    {
                                                        item.supports == '' ? '' : item.supports.map((item, index) => {
                                                            switch (item.id) {
                                                                case 7:
                                                                    return (<span className="index-iconDelivery2"
                                                                                  key={index}>
																				<span>蜂鸟专送</span>
																			</span>);
                                                                case 9:
                                                                    return <span className="index-iconDelivery1"
                                                                                 key={index}>准时达</span>;
                                                                default:
                                                                    return;
                                                            }
                                            ...
                                            <section className="index-line">
                                                ...
                                                <div className="index-timedistance">
                                                    <span
                                                        className="distance">{item.distance < 1000 ? item.distance + 'm' : (item.distance / 1000).toFixed(2) + 'km'}</span>
                                                    <span
                                                        className="time">{item.order_lead_time == 0 ? '' : '/ ' + item.order_lead_time + '分钟'}</span>
                                                </div>
                                            </section>
                                        </div>
                                    </li>
